...
evalfields = {'Debug', 'MaxIter', 'MaxFunEvals', 'TolMesh', 'TolStallIters', ...
    ...
    'UncertaintyHandling', 'NoiseObj', 'UncertainIncumbent', 'Nfinalsamples', 'NoiseSize', 'MeshNoiseMultiplier', 'TolPoI', 'SkipPoll', 'ConsecutiveSkipping', 'SkipPollAfterSearch', 'CompletePoll', 'MinFailedPollSteps', 'NormAlphaLevel', ...
