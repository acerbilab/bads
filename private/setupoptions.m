...
evalfields = {'Debug', 'MaxIter', 'MaxFunEvals', 'TolMesh', 'TolStallIters', ...
    ...
    'TolImprovement', 'ForcingExponent', 'PollMeshMultiplier', 'IncumbentSigmaMultiplier', 'ImprovementQuantile', 'FinalQuantile', 'AlternativeIncumbent', 'AdaptiveIncumbentShift', 'FitnessShaping', 'WarpFunc', ...
    ...
    'UncertaintyHandling', 'NoiseObj', 'UncertainIncumbent', 'NoiseSize', 'MeshNoiseMultiplier', 'TolPoI', 'SkipPoll', 'ConsecutiveSkipping', 'SkipPollAfterSearch', 'CompletePoll', 'MinFailedPollSteps', 'NormAlphaLevel', ...
