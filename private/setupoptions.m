...
evalfields = {'Debug', 'MaxIter', 'MaxFunEvals', 'TolMesh', 'TolStallIters', ...
    'TolFun', 'TolNoise', 'Ninit', 'InitFcn', 'Restarts', 'CacheSize', 'FunValues', 'PeriodicVars' ...
    ...
    'gpdefFcn', 'gpCluster','RotateGP','gpRadius','UseEffectiveRadius','PollAcqFcn', 'SearchAcqFcn', 'AcqHedge', 'CholAttempts', 'NoiseNudge', 'RemovePointsAfterTries', 'gpFixedMean', 'FitLik', 'gpSVGDiters', 'InputWarping', 'InputWarpStart', ...
    ...
    'AccelerateMesh', 'AccelerateMeshSteps', 'SloppyImprovement', 'HessianUpdate', 'HessianAlternate', 'gpWarnings', ...
