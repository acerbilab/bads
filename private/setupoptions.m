...
evalfields = {'Debug', 'MaxIter', 'MaxFunEvals', 'TolMesh', 'TolStallIters', ...
    ...
    'gpdefFcn', 'gpCluster','RotateGP','gpRadius','UseEffectiveRadius','PollAcqFcn', 'SearchAcqFcn', 'AcqHedge', 'CholAttempts', 'NoiseNudge', 'RemovePointsAfterTries', 'gpFixedMean', 'FitLik', 'gpSVGDiters', 'InputWarping', ...
