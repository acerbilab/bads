...
if failed == 0
    display('BADS is working correctly. See bads_examples.m for usage examples, consult the <a href="https://github.com/lacerbi/bads">online documentation</a>'); 
    display('or digit ''help bads'' for more information. Enjoy!');
else
    display('BADS is not working correctly. Please check the <a href="https://github.com/lacerbi/bads">online documentation</a> for more information.');
end
