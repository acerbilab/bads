...
evalfields = {'Debug', 'MaxIter', 'MaxFunEvals', 'TolMesh', 'TolStallIters', ...
    ...
    'TolImprovement', 'ForcingExponent', 'PollMeshMultiplier', 'IncumbentSigmaMultiplier', 'ImprovementQuantile', 'AlternativeIncumbent', 'AdaptiveIncumbentShift', 'FitnessShaping', 'WarpFunc', ...
