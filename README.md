...
**News:** 
- I recently released [Variational Bayesian Monte Carlo (VBMC)](https://github.com/lacerbi/vbmc), a new toolbox for Bayesian posterior and model inference accepted at NIPS 2018 that you should check out!
